...
echo -e " docker run --name app --rm --init -t --env-file=.env --link mongodb -p 4300:4300 compose_app ${NC}"
docker run --name app --rm --init -t --env-file=.env --link mongodb -p 4300:4300 compose_app
